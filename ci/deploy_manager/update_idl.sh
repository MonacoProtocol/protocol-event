...
# usage  ./ci/deploy_manager/update_idl.sh -e ENVIRONMENT -t DEPLOY_TYPE < stable | dev > -f FILE_PATH
# ./ci/deploy_manager/update_idl.sh -e devnet -t stable -f target/idl/0.1.0.stable.21fc7474.json
